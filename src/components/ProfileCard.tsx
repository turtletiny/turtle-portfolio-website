...
const socials = [
  {
    icon: YouTubeIcon,
    href: "https://www.youtube.com/@turtletiny",
    label: "YouTube",
    hoverClass: "group/yt",
    iconSize: 18,
  },
    ...
    <div className="card-base flex flex-col gap-8">
      <div className="flex items-center gap-6">
        ...
        <a
          ...
          className="relative w-20 h-20 flex-shrink-0 overflow-visible hover:scale-105 transition-transform"
        >
          <div
          ...
          />
          <div
            className={`absolute bottom-0 right-0 w-[22px] h-[22px] rounded-full border-4 border-card z-[6] ${statusColors[status]}`}
          />
        ...
        <div>
          ...
          {customStatus && (
            <p className="text-foreground text-sm mt-1">{customStatus}</p>
          )}
        </div>
      </div>
