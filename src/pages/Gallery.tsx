          ...
          >
            ...
            <div className="card-base flex flex-col gap-4 w-full md:w-1/3 p-6 flex-shrink-0">
              ...
              <div className="flex flex-wrap gap-2 mt-4">
                {selectedItem.tags.map((tag: string, index: number) => tag && (
                  <span key={index} className="px-3 py-1 bg-secondary rounded-full text-xs font-medium border border-border">
                    {tag}
                  </span>
                ))}
              </div>
