    ...
    <div className="card-base flex flex-col">
      ...
      <div className="flex items-center justify-between flex-grow pb-3">
        <div className="flex flex-col">
          <p className="font-bold text-3xl tabular-nums tracking-wide">{time || "--:--:--"}</p>
          <p className="text-muted-foreground text-sm font-medium">Sydney, Australia</p>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <p className="font-bold text-3xl leading-none">{weather ? `${weather.temp}°C` : "--°C"}</p>
        </div>
      </div>
    </div>
  );
