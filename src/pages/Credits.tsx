...
const learningLinks = [
  {
    ...
    url: "https://medium.com/@drimesbot/how-to-show-what-youre-currently-listening-to-on-your-personal-website-or-portfolio-spotify-635f433978a0",
    desc: "Tutorial Article",
  },
  {
...
const inspirationLinks = [
  {
    ...
    desc: "collection of cool ui websites",
  },
  {
    title: "Web of Devs",
    url: "https://webofdevs.com/",
    desc: "Collection of Dev Portfolio Sites",
  },
];
...
const otherLinks = [
  {
    ...
    desc: "Cool colour palette site can be useful",
  },
  {
    title: "Protocol Cards",
    url: "https://protocolcards.com/",
    desc: "Cool little protocols for calming anxiety",
  },
  {
    title: "forgoodcode",
    url: "https://www.instagram.com/forgoodcode",
    desc: "Useful Instagram page on using AI effectively, learning resources, etc",
  },
  {
    title: "bigpro427",
    url: "https://www.tiktok.com/@bigpro427",
    desc: "Goldmine of informational science based lifting content",
  },
  {
    title: "Erin Meryl",
    url: "https://www.youtube.com/@erinmerylstudy/videos",
    desc: "Pretty entertaining and inspiring study content",
  },
];
  ...
  const LinkItem = ({ link }: { link: any }) => (
    ...
    >
      <div className="flex items-center justify-between">
        <h3 className="font-bold text-[15px] group-hover:text-primary transition-colors">
          {link.title}
        </h3>
        <ExternalLink
          size={16}
  ...
  return (
    <div className="min-h-screen flex flex-col items-center bg-background text-foreground font-main">
      ...
      <div className="w-full max-w-[900px] flex flex-col gap-6 px-4 pb-12">
        ...
        <div className="card-base flex flex-col gap-4">
          <div className="text-xs font-bold tracking-wider text-muted-foreground flex items-center gap-2 mb-2">
            <CardSectionIcon darkIcon={Lightbulb} pastelEmoji="💡" />{" "}
            INSPIRATION
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="card-base flex flex-col gap-4">
          <div className="text-xs font-bold tracking-wider text-muted-foreground flex items-center gap-2 mb-2">
            <CardSectionIcon darkIcon={LinkIcon} pastelEmoji="✨" /> OTHER COOL
            STUFF
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
